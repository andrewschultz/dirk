...
before undoing an action:
	...
	if in-beta is true or debug-state is true:
		say "[line break]But this is a [if debug-state is false]beta[else]debug[end if] version, so we'll let it slide.";
		the rule succeeds;
	the rule fails;
...
to say cmds:
	say "U/L/D/R to move Dirk (F and B for Forward and Back also work,) S for sword/attack, or Z to wait, which is usually a bad idea but sometimes gets you extra points. H gives a command list, and an empty command (or I) refreshes your current situation"
...
to dirkmove (a - a number):
	...
	if a is 1:
		if wait-check entry bit-and 1 is 1:
			...
			the rule succeeds;
		say "You hear a weird buzz.[paragraph break]You're generally a man of action, Dirk, unless that action involves getting to the library to study up on adventuring theory. But which of the five actions to take?";
		continue the action;
...
carry out creditsing:
	say "Creating this silly game was the end of a long, fun journey.";
	...
	say "Thanks to Don Bluth for creating Dragon's Lair. Although the humiliation of that one time I scored 'only' 147 still burns, it was great fun just imagining making my own rooms and also over-romanticising how hard the later rooms were.";
	say "Thanks to www.dragons-lair-project.com for having the walkthrough of 'easy mode.' And for permission to integrate it.";
	say "Thanks to the folks who created the Dragon's Lair DVD so I could solve it there.[wfak]";
	say "Thanks to Uptown Arcade for having a Dragon's Lair machine I finally beat in January 2020. It got the year off to a great start.";
	say "Thanks to DJ Tommy for his walkthrough video at https://www.youtube.com/watch?v=hdumVFgwgP8.";
	say "Thanks to Biff's Gaming Videos for breakdowns of each room.";
	...
	say "Last and certainly not least (trivia: people are 2nd-most likely to click on the last in a list of links,) thanks to Greg Boettcher for originally holding Spring Thing, and to Aaron Reed for creating the Back Garden so I felt comfortable submitting a silly game like this. Oh, and thanks to you, if you submit a transcript to [email] that helps me with any issues, big or small. Any bit helps, and I'm glad to trade testing back in return.";
	the rule succeeds;
...
carry out hing:
	say "Here are the main commands: [b]U[r]/[b]D[r]/[b]L[r]/[b]R[r] moves Dirk up, down, left or right. [b]S[r] uses his sword. [b]F[r] (forward) can be substituted for [b]U[r], and [b]B[r] (back) can be substituted for [b]D[r].";
	...
	say "[line break]A blank command, or [b]I[r], will let you look. If you've already moved in your current room, it will print the last thing that happened[one of]. This may be useful right now[or][stopping].";
	if in-beta is true:
		say "[line break]There are also two tester commands, too: [b]J[r] lets you jump past this room, and [b]P[r] picks off rooms different in easy vs. hard mode.";
	the rule succeeds;
...
Twirling Boulders is a room. it is doubled. "You're on a narrow walkway. Two spinning boulders on sticks, in a circle, periodically block your passage forward. As seems to be the case too often, there's no way back. You haven't wasted a lot of thought on this, which is probably for the best."

Lizard King is a room. "Oh no! A magnetic pot of gold schlurps your sword from your scabbard, ten feet away. Then it jangles off. You run to a T-intersection where a weird grunt from the right reveals a giant lizard in purple robes. He raises a dangerous looking golden scepter."

Smithee is a room. it is doubled. "You stick your sword in a magic fire, and immediately another glowing sword whistles and comes swooping down at you[one of]![or]! Didn't you learn anything last time, Dirk?[stopping] Oh, yeah, there's also fire on a couple sides of you."
...
Tentacle Room is a room. "Well, this isn't too bad, for starters. Okay, an exit door just shut. But only one tentacle lashes out from the ceiling, just daring you to slice it."

Snake Room is a room. "You're trapped in a cell. A snake pops down from the ceiling and hisses at you!"
...
a room called Slide and Pit is a room. "Aaaaaa! A slope leads to a pit ahead of you, down! There's a wall to your left, but in a fit of Universal Pespective, you imagine it's to the right, for people who might be controlling you, if that is indeed how the world operates."

Giddy Goons is a room. "A tiny purple flying pig with a dagger comes bouncing impossibly out from the left! It's either very confident, or very backed up by friends who'll totally bumrush you if you're passive."
...
Bat King is a room. "You're dive-bombed by bats. Not enough to flee, but you should ward them off. Maybe by then enough walkways will vanish, and all that pesky distracting choice will go, and it'll be clear what to do next."

Electric Throne is a room. "Zzzaap! A shiny ball in front of a throne siphons your scabbard away from you. To make matters worse, the circular room you're in? The rug starts vsnishing, consumed by electricity. There's a lot of volts on that shiny floor to the left and behind, and now, up ahead."

Vanishing Checkerboard is a room. "Oh, man! You always hated checkers. You always wished checkerboards would disappear. But you're sort of getting your wish, here. The tiles you are on are starting to vanish, and quickly. And the two exits--a shut cage doors up and a closed door to the left--are closed."
...
to say fwd-easy:
	if hard-mode is false, say " and forward"
...
Horsing Around Walls and Fire	false	false	0	0	8	--	495	495	"You avoid the fire to the [r-l]. Now there's a wall ahead and to the [r-l]. Variety! But nothing crazy."	"You and your horse crash into the fire to the [r-l] HOT HOT HOT!."
Horsing Around Walls and Fire	false	false	0	0	8	--	1326	1326	"You avoid the wall! There's another wall ahead and to the [r-l]. It looks more or less as lethal to fly into as the previous one."	"[horse-fly]."
Horsing Around Walls and Fire	false	false	1	0	8	--	495	495	"Your horse crashes into the ground. You brush yourself off, kicking open a door hard enough that it slams shut behind you to deflect a random bolt of lightning. Take that, deportment classes you hated!"	"[horse-fly]."
...
Underground River	false	false	0	0	8	--	379	--	"You navigate to the left, remembering you row your oar on the right. PHYSICS! Now there's a flash to the right! You haven't seen too many flashing rocks. Glowing, yes, but not flashing. You're one for one so far. Time to go two for two!"	"[splat-pur]."
...
Underground River	false	false	0	0	4	--	379	--	"Blam! Four for four! As the water changes from purple to orange, you float along, past a sign saying YE RAPIDS, where you see a passage to the right[fwd-easy]. It's dang near a road, a lighter orange than the rest of the river![paragraph break]You were no ace in adventurer physics, but you're pretty sure the different colors don't change TOO much that's important, here."	"[splat-pur]."
Underground River	false	false	0	0	36	--	495	--	"Yup, you'll be okay as long as you remember to row from the opposite side. Now that stripe is left[fwd-easy]."	"[or-scen]."
Underground River	false	false	0	0	40	--	495	--	"Bang on again, Dirk. You're almost too cool for school. Now that stripe is right[fwd-easy]."	"[or-scen]."
Underground River	false	false	0	0	36	--	495	--	"Now it's left[fwd-easy]. It's like military camp with the left right left right!"	"[or-scen]."
...
Underground River	false	false	0	0	8	--	251	--	"One more reverse-paddle, for Roman Hruska. The water picks up speed. You're thrown into the air. But there's a chain there, up and to the right. It flashes and dings, making it 25% more grabbable, or something. You don't have time for the mental math."	"[whirl-d]."
...
U and Pool Balls	false	false	0	0	16	--	251	--	"What luck! The red ball rolls by, and as you sneak through, it rolls back to be crushed by the black ball. Just in case you needed proof the black ball was destructive and not just scary.[paragraph break]Now there's an orange ball crossing in front of you down back. The black ball hasn't slowed down."	"You get smooshed by the black ball. Or the red[u-nfair]."
U and Pool Balls	false	false	0	0	16	--	379	--	"Now it's the orange ball's turn to crash into the black ball after missing you. You remember learning to cross a street watching for chariots, and how your parents told you it was no joke. They were right! Oh, look, a yellow ball passes by down below."	"You get smooshed by the black ball. Or the orange[u-nfair]."
U and Pool Balls	false	false	0	0	16	--	379	--	"The yellow ball is not too yellow to crash into the black ball after missing you. Behind, again, is a green ball. There can't be too many more colors, can there?"	"You get smooshed by the black ball. Or the yellow[u-nfair]."
U and Pool Balls	false	false	0	0	16	--	379	--	"The green ball goes kablooie, and the black ball doesn't even have a crack in it! Well, there's a blue ball passing ahead. It's a dark manly blue, but you won't care about colors if you don't get past it. That leaves just one ball. You have no clue whether it's purple, indigo, or violet, because you hated art class. You figured someone had to be the person whose deeds were worth noting via art."	"You get smooshed by the black ball. Or the green[u-nfair]."
U and Pool Balls	false	false	0	0	16	--	379	--	"The color variety is nice, especially because you forgot Roy G Biv, and it keeps you alert. And because you forgot Roy G. Biv, you don't know if the bal passing by below is purple, indigo or violet, and you wouldn't really have the time to work it out even if you could. Action!"	"You get smooshed by the black ball. Or the blue[u-nfair]."
...
Cage and Geyser	false	false	0	0	32	--	1326	--	"You time the door perfectly! You start to jump just as it shuts, so that you pass by when it's fully open. And they said you didn't understand physics![paragraph break] There's a narrow bridge across, with a huge flume of lava to the left. It sprays upwards every few seconds."	"Hesitating, you time the jump through the door wrong as the electrical current approaches. SNAP!"
Cage and Geyser	false	false	1	0	8	--	2191	--	"Your classmates made fun of you because you couldn't count, but man, you sure have timing down. And you don't stop for one second to try and understand if it is a natural phenomenon. The next flume just misses you as you run left. Your classmates, all in worse physical shape, would not have made it."	"Perhaps you felt guilty of your impeccable timing. Or perhaps you just have a fear of crumbly bridges. Or you wonder how the bridge survived the first flume. Whichever, it does not matter now where you are."
...
Black Knight on Horse	false	false	0	0	8	--	1939	--	"The more aesthetically oriented parts of gymnastic gave you fits, but thanksfully, they don't apply here. Another roll to the left, and you escape the knight again. Oh, look. There's a hole to the right! No thorns!"	"Too bad, Dirk! The black knight rides off with your helmet on his sword. How it got there, you may not have figured, and you may not want to know."
...
Twirling Boulders	false	false	0	0	32	--	4026	4750	"You ignore computing the relevant angular velocities, instead concentrating: I don't want the left boulder to hit me, or the right. So I'd better go forward when they BOTH just pass my by. Your mad sprint succeeds![paragraph break]A ghostly apparition--well, it's more a sheet than anything--opens its folds ahead and draws a glowing weapon. You hear thorns spring up behind you and to the sides. Good thing you didn't cheat and crawl through--you'd have been prone!"	"You panic, worrying too much about maybe stepping at the wrong time, or even if you can sneak off to the side. The boulders send you out--the wrong way!"
Twirling Boulders	false	false	0	0	2	--	2191	2191	"Shtwack! You've beaten lots scarier ghosts than that in practice. But thorns spring up to each side. Again. And in front of you. You've heard of parasite plants, but this is ridiculous. You don't have time to think why the ghost was guarding that wall up ahead, either, or why the path behind suddenly cleared."	"As the ghost strikes you with a glowing rod, you worry any adventurers you meet in the afterlife will snark on how you were supposed to be GOOD with a sword, but you botched that."
Twirling Boulders	false	false	0	0	16	--	1326	1326	"You escape the thorns! You get disoriented, which is bad (timing those boulders was TOUGH,) but you see an exit forward that you missed before, which is good."	"You fail to move back away from the thorns."
...
Lizard King	false	false	0	0	40	--	1939	--	"You run forward some more after the magnetic pot to another T-intersection. Uh-oh, Dirk! The Lizard king has you trapped from the left. He raises his scepter again."	"[konk]."
Lizard King	false	false	0	0	4	--	1326	--	"And now he is coming at you from the left at another T-intersection! Lucky you, the pot doesn't seem to want to double back behind the Lizard King."	"[konk]."
Lizard King	false	false	0	0	4	--	1326	--	"You run right some more, and the Lizard King appears to the left again and raises his scepter at yet another T-intersection! You have no time to reflect that it's sort of good the Lizard King isn't sneaking between you and your sword, but it is. The metal pot with your sword barely keeps in sight."	"[konk]."
Lizard King	false	false	0	0	4	--	1326	--	"The chase continues. The Lizard King raises his scepter again to the left. If you'd stayed awake during biology, you'd understand the term 'Lizard Brain' a bit better."	"[konk]."
Lizard King	false	false	0	0	4	--	1326	--	"And again! The Lizard King shows up from the left! Aren't those heavy robes going to take a toll soon? More importantly, if you've taken a right turn four times, why aren't you back where you started? "	"[konk]."
Lizard King	false	false	0	0	4	--	2191	--	"You wonder how much more of this there is until you run into a dead end, which would be really bad if your sword wasn't there, by the metallic pot of hold, which has calmed down."	"[konk]."
Lizard King	false	false	2	0	34	--	3255	--	"[if hard-mode is true]You grab your sword! It's a bit more even, now.[else][dirk-d-king].[end if]"	"All that running, and you found it tough to change pace at the dead end, Dirk. The fight ahead [if hard-mode is true]would've been long, but you were in better shape[else]might've been very short indeed--in your favor[end if]."
...
Smithee	false	false	0	0	2	--	915	1326	"Well, the sword being perpendicular to your sword, that gave a greater range--ah, heck, you just swung when it looked like a fat target, and CLANG. Ooh! Here comes a mace flying in!"	"The magic sword descends on you. At least you weren't beaten by someone weaker than you."
Smithee	false	false	0	0	2	--	1939	2191	"The mace isn't appreciably different. Well, it's appreciably not different to deflect. But now a glowing anvil up ahead rises and swerves rapidly at you. If it had eyes, they'd be glowing even more than the anvil itself, because you kind of killed its two favorite children, and running away won't work.[paragraph break]Oh, there's also fire to your [r-l]."	"The mace gets too close before you realize you should swing your sword, which shatters."
Smithee	false	false	0	0	8	--	1326	1326	"Wow! You duck, but now a spear rises from a weapons rack and spins at you. Time it right, and you can smack it just SO."	"[if went-r]You pause, then jump the wrong way into the fire[else]You couldn't avoid getting clobbered into a wall by the flying anvil[end if]."
Smithee	false	false	0	0	2	--	1326	1326	"Well done, Dirk! That's one thing those scries and their transcription and insistence on detailed instruction will never get.[paragraph break]You hit the spear JUST perpendicular, because the angular momentum needs to be--nah, you just didn't want it to point straight at you. You treat your sword to a bit of magic fire, because that magic fire couldn't have had anything to do with those hostile weapons, and a statue wakes up and growls, raising its axe."	"Wham! The spear smacks you just so. Well, it was a pretty tough practical physics problem, Dirk."
...
Tentacle Room	false	false	0	0	2	--	49	--	"A tentacle that bright green is hard to miss. So is that weapon rack flashing on the wall forward a ways."	"Now wasn't the time for amateur botany, Dirk!"
Tentacle Room	false	false	0	0	32	--	379	--	"You jump ahead just in time to escape some tentacles, and to see another squeezing down from above. Oh! Hey! There's that door out of here flashing to the right! It's open, too!"	"[tent-die]."
Tentacle Room	false	false	0	0	4	--	495	--	"The door shuts. The tentacles close in. But they're absent from the stairs behind you--the ones that are flashing now!"	"[tent-die]."
Tentacle Room	false	false	0	0	20	--	915	--	"As you go right and climb the stairs, tentacles swarm down from there. Looks like you better retreat. Hey! That bench is flashing to the left!"	"[tent-die]"
Tentacle Room	false	false	0	0	8	--	1326	--	"Yours not to reason why, but that door ahead is open now--and flashing! Well, it's opening and shutting, but you can time it"	"Well, you gave it your best shot, but there were too many tentacles coming from the stair. At least they don't insult you as they squeeze you to death."
...
Snake Room	false	false	1	0	36	--	1939	--	"You grab it, revealing a trap door up. The rope also falls down. It's easy to climb. Go, Dirk!"	"You missed your chance, Dirk. You wait around, wondering if you should've pulled the skull, then finally wondering if fellow adventurers in heaven will laugh at you for not being clever enough to at least try, as a snake wraps itself around you."
...
Goop Room	false	false	1	0	4	--	1326	--	"That's enough of this room. It was scary, but at least you didn't have any uncomfortable choices. Just avoid the goop."	"You wait for the next wave of goop, and there's more than you thought. Ugh!"
Slide	false	false	0	0	8	--	495	--	"You tumble ... the right way, to a narrow passage. You feel re-oriented. A weird bug-eyed stalk blocks your passage to the left across the narrow walkway!"	"You fall down the shaft. Really, that was sort of unfair, how quick it happened, but what did you expect, from an evil intelligent dragon?"
Slide	false	false	0	0	2	--	1939	--	"And now there's another one, bigger, stronger, from the right! If you weren't on a narrow walkway, you'd have no problem, Dirk. Buit you can't fight them all day."	"The stalk grabs you as you try to walk across."
Slide	false	false	0	0	9	--	915	--	"You walk up the stairs, and they widen. Ooh! There's a shiny chain to pull ahead! If there was a gap, it could lead you to another room just like that flashing exit to your left would. It's tempting to go forward and pull it."	"This time you're not quite ready. The stalk is too big. It drags you down!"
...
Giddy Goons	false	false	0	0	2	--	379	--	"You've learned by now that slashing at the first enemy is always a good start. Well, you sort of knew it already. But at least you didn't forget. Several weird piggies come bouncing from the left, now! They're armed, but they're not chasing VERY fast, after what you did to their comrade."	"Ouch! The underdog's grit and hustle (accompanied by several other underdogs, and their grit, and their hustle) catches you off-guard. You should have been more direct, Dirk."
Giddy Goons	false	false	0	0	4	--	1326	--	"You head right. Maybe they'll tire out. Being that heavy while bouncing, well...whew. And those stairs just up ahead--well, you're fit enough for them."	"You take a slice at one, but two others cover your face."
...
Fire and Lightning Room	false	false	1	0	8	--	1326	--	"Well, what do you know? You're able to move the bench and crawl through the passage. Other more knowledgeable adventurers would have figured no way, but not you, Dirk! You took the only chance you had, and quickly."	"[o-w-g]."
...
Earthquake Room	false	false	0	0	4	--	2191	2675	"There's a pool ahead! The bottom hasn't fallen out yet. Okay, maybe it has, but you do know how to swim. And staying on what's left of the ground isn't an option."	"You stay next to the wall, which is more solid than the ground, but unfortunately it's less supportive."
...
Earthquake Room	false	false	0	0	32	--	3551	4026	"Ooh! You ran into the forward[l-r] corner of the room. And you can't go back. A spider descends to taunt and possibly attack you."	"You stay by your old friend the wall, the only thing that didn't collapse here. It stays with you as you fall all the way down. There's a lot of it."
Earthquake Room	false	false	0	0	2	--	4026	4026	"It's good to have some sword action after all that running. But now, back to being chased by whatever earthquakes are after you. The way behind is blocked. But an open doorway is [r-l]."	"Ouch! Tough to change gears, Dirk. The spider grabs your head and even keeps you from falling once the ground crumbles. But it grabbed so hard, you aren't conscious enough to appreciate it."
Earthquake Room	false	false	0	0	4	--	5000	5000	"You're by the door out of here, just ahead! To your relief, the ground quits crumbling. But then you realizethe block of ground you're on is rising--and you'll get crushed by another block coming from above."	"Maybe you feel bad about killing the spider, or whatever. You don't have much time to think about it, though, as you're falling."
...
Bats and Walkway	false	false	0	0	32	--	915	--	"The walkway behind crumbles. But there's still more to go. Good thing this isn't a maze--the confusion of actually having a choice might make you freeze up and fall to your doom."	"Well, there wasn't that much out there to grab a hold of, you think, seeing the narrow passage up then right. Did you really have a chance?"
Bats and Walkway	false	false	0	0	40	--	915	--	"The walkway destruction stops just in time for bats to swoop at you from the other way! How to ward them off?"	"The crumbling walkway catches up to you. It confuses the bats, sort of, but you're in no position to appreciate that."
Bats and Walkway	false	false	0	0	2	--	2675	--	"Normal service is resumed as the walkway crumbles. But wait! There's still a physically impossible walkway half in mid-air, flashing to the right.[paragraph break]Hey! Part of it disappeared as it flashed! No fair! Only doors are supposed to flash and disappear! I mean, you can probably jump over, but it's the principle of the thing."	"Oh, too bad! You missed a chance to lash out at the bats and take a break from running. It isn't their fault the walkway crumbled, but all the same, it'd have been nice."
...
Electric Knight	false	false	0	0	4	--	1939	2191	"Ooh! Look! The knight mashes his sword, laughing, and now there's an opening to the [l-r]."	"[woulda-quick]."
...
Electric Knight	false	false	0	0	4	--	4026	4750	"Okay, he's out of charges. And boy is it convenient you're right by him! And that he's winding up for his sword-blow like a baseball batter! What's baseball, you say? Oh, Dirk. Some day I hope you learn, and you feel the thrill of hitting a towering home run."	"[woulda-quick]."
Electric Knight	false	false	1	0	2	--	2191	2675	"Slash! Bam! Dirk, you would've taken that knight down even if he hadn't spent time chuclling and pulling his sword back. He's the closest thing to a talking villain as you can get, since nobody's done any talking, yet. There's a gap to jump over ahead, but that's nothing compared to the board."	"It was too hard to change gears from jumping around to your sword-waving. Or maybe you hoped that if you waited, the knight would chop off his own head as he drew his sword back. It doesn't matter now."
...
Bat King	false	false	0	0	8	--	2191	--	"Oop! There's a narrow stairwell ahead. But then the stairs in front of you crumble. You could just make it if you jump over them."	"You fail to jump forward over the gap. Well, falling means you won't get mobbed by the bats. That's...something."
Bat King	false	false	0	0	40	--	1326	--	"Oh, hey, how's this for variety? After all those small bats swarming you in mid-air, here's a giant bat that can't fly stumbles out of a doorway and raises his wings. You can't exactly go back, or through the bat."	"Aaaa! That's not the way to jump the gap ahead."
...
Electric Throne	false	false	0	0	36	4	3255	--	"The circle's almost closed. The throne is up and to the right."	"Zzzzzzap! Megavolts, coming right up."
Electric Throne	false	false	0	0	4	--	2675	--	"The throne is safe from the current, for the moment. But then it spins you around as your scabbard snaps back in place. The electric charge starts to work its way up the throne. But wait! There's an exit to the right!"	"Zzzzzzap! Megavolts, coming right up."
Electric Throne	false	false	1	0	4	--	1939	--	"You stumble out before the electricity gets to you."	"You always wondered what it'd be like to have a nice long seat on a fancy throne. It would probably have been more pleasant if you'd been alive for it."
Vanishing Checkerboard	false	false	0	0	16	--	1939	--	"A safe jump back! You're farther from the exit, though. And now the tiles between your feet disaappear. And behind you, too, but no big loss there. The fire ahead dissipates."	"Your weight must've caused the nearby tiles to fall a bit quicker. You consider this hypothesis during the long tumble down."
Vanishing Checkerboard	false	false	0	0	32	--	2675	--	"Now you've moved back to where you started, two doors flash: to the left, then forward. If you'd paid more attention to adventuring theory, you'd know this wasn't fair. Though you're ... you're pretty sure the door to the left flashed first, though. "	"Your next jump doesn't get you anywhere nearer the exits, or to a more populated area to jump. You fall to your doom."
Vanishing Checkerboard	false	false	1	0	8	--	1939	--	"Whew! You jump on the stair ledge by the door to the left, then walk through."	"[if went-u]Wrong choice, Dirk! Ahead leads to a cage. A grate falls down where the door was. You scream and rattle the bars, but no luck[else]Faced with two similar-seeming choices, you find a third horrendous one. You fall to your doom[end if]."
Mud Monsters	false	false	0	0	2	--	1326	--	"The mud monsters go quiet and back up a bit, allowing passage ahead. As you re-sheath your sword, you hear their blurp bloop blurp behind and to the sides."	"[mudmon-yay]."
Mud Monsters	false	false	0	0	33	--	1326	--	"Oo! A green geyser to jump over! It just finished firing! And it flashed, too! Double bonus! You've been through enough to know what that means, now."	"[mudmon-yay]."
Mud Monsters	false	false	0	0	32	--	2191	--	"Some more rambling across the mud. Your speed more than makes up for your lack of familiarity with the terrain. The mud monsters follow, but not very closely.[paragraph break]Two geysers ahead won't stop firing. But ... you could probably squeeze through them!"	"[mudmon-yay]."
Mud Monsters	false	false	0	0	36	--	2675	--	"Oh, hey, there's a path ahead to the next geyser, between bubbling lava on each side!"	"[mudmon-yay]."
Mud Monsters	false	false	0	0	32	--	1326	--	"The green geyser just ahead fires. The passage is kind of narrow, so you can't really walk around it. But ... you've seen this before. Like, half a room before."	"[mudmon-yay]."
Mud Monsters	false	false	0	0	32	--	1326	--	"Wow! A wide red pool of mud ahead, and you on a plank being followed by mud men. Thank goodness the plank's up high, so you can jump a bit farther."	"[mudmon-yay]."
Mud Monsters	false	false	0	0	32	--	1326	--	"And one more green geyser ahead to jump over!"	"[mudmon-yay]."
Mud Monsters	false	false	0	0	32	--	1326	--	"You hear a squilching sound behind--like when you cut previous enemies open with a sword. But the mud monsters don't die--they appear in small geysers to the side. You forget how not-fair this is when you see the exit forward across one final green river! If you were more of a naturalist, you might be disappointed you didn't get to jump a red geyser for variety, or something, but really, it's time to move on. It was...straightforward."	"[mudmon-yay]."
...
Dragon's Lair	false	false	0	0	8	--	1326	--	"You're not just brawn, Dirk! You're quickness, too! You catch the pile of trinkets before it falls, and the dragon doesn't wake up enough. Well, he does, enough to send out a gout of flame. Fortunately there's a gold pile to your left!"	"It's not your fault the trinkets fall to the ground, but the dragon doesn't seem to care. It's more upset to have found an intruder. You are roasted by the dragon's breath!"
...
Dragon's Lair	false	true	0	0	32	--	2191	--	"The dragon's flame hits the gold pile! There's another pillar to the right to hide behind."	"Singe, with you clearly in view, lets out a sheet of flame. It doesn't miss."
...
Dragon's Lair	false	false	0	0	4	--	3255	--	"One last time, you hide behind a pillar as the dragon's breath deflects off it. And what do you see ahead but--the magic flaming sword! You don't need the heavenly chorus to clue you that the sword is potentially awesome, but you can't grab it til you approach it."	"The dragon is not just sly at hand-to-hand combat. He knows a few angles. Maybe he got some of his wealth at pool hu--oops, that's not important. What is, is, you're fried to a crisp."
Dragon's Lair	false	false	0	0	36	--	2191	--	"You jump towards the sword! But you haven't grabbed it yet. It's too un-dramatic to grab it right away. Maybe now, with Singe really bearing down on you. He breathes out..."	"The flame from the sword has nothing on Singe's flame, as you find out."
...
Dragon's Lair	false	false	0	0	2	--	4026	--	"The magic sword does not break. Singe looks a little worried. But you're too close to him (he's JUST right and down) to throw the sword, and stabbing him won't do enough damage."	"So close, Dirk. You die without feeling guilty that, now Singe almost got killed, he will hide the sword somewhere really tough. You don't quite have the analytical skills to consider how tough or even impossible this will make things for the next adventurer, but it's probably best that way."
...
[these are obsolete with zarf's test script. yay.]
