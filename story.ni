...
to dirkmove (a - a number):
	...
	d "Comparing [rightmove entry] [X] to [a]...[if is-mirrored is true]--but mirroring[end if], in row [row-in-moves].";
	if (X bit-and a) is a:
...
Flaming Pit	false	0	1	4	251	379	"You grab onto a rope. The timing's easy enough. Another swings back from the [r-l]."	"The ledge you were on retracts fully. You fall screaming to your doom."	"You fidget nervously, watching the ledge almost retract. Way to make it tougher! Still, you can hear the noises of the ropes swinging back and forth..."
Flaming Pit	false	0	2	4	100	100	"Using only your senses, you grab onto the rope as it comes back! Ok, it might've been easier if you weren't looking down in fear at the almost-retracted ledge, but details."	"Unable to grab the swinging rope to the [r-l], you fall screaming into the pit."	"That was a bit TOO long to wait, Dirk. A rapidly accelerating fall follows your inaction."
Flaming Pit	false	0	0	4	379	495	"You grab the next rope, not thinking about it. The eggheads up on adventure theory might think a second too long and draw parabolas in their head and calculate things to three significant figures, but not you, Dirk. Ooh! Anther rope swings back from the [r-l]."	"[obliv]."	"Y[rope-wait]."
Flaming Pit	false	0	0	4	495	495	"You grab the next rope yet again, not even worrying if you might mess this up. Oh, hey! There's a ledge to the [r-l]! You reach out your hand reflexively."	"[obliv]."	"This time, y[rope-wait]."
Flaming Pit	false	1	0	4	915	915	"You jump off the rope and onto the ledge and through the door."	"At the last minute, you decide to jump [r-l], but you don't have enough momentum. Your feet wobble on the edge of the ledge you jump on. You fall into the pit. Boo, physics."	"This time, y[rope-wait]."
Closing Wall	false	1	0	32	379	379	"You jump through the wall and land awkwardly but safely."	"You look for a way around the wall, then try to sneak through as it shuts. You make it halfway, which isn't good enough."	"The wall closes, then poison gas seeps in from all around. Well, that bed will be a nice comfy final resting place."
...
Crypt Creeps	false	0	0	32	915	2191	"Oh no! A big skeletal hand appears from a doorway to the [l-r]!"	"The skull heads seem to bounce higher on each other until they envelop you completely. You swing your sword, but it can't reach that close."
Crypt Creeps	false	0	0	2	495	495	"You slash the huge skeletal hand, neglecting to fear the big monster behind it that hasn't made it through the wall. Now tar starts oozing out ahead...but the skeletons behind are yucky, too."	"There's no running. The hand grabs you."
Crypt Creeps	false	0	0	32	915	2191	"Whew. Now another big skeletal hand, this time from the [r-l]! At least it's still just a hand."	"You are stuck in the tar before you can make it forward."
...
Underground River	false	0	0	4	251	--	"The whirlpool may be going somewhere interesting, but not any good. Whirlpool to the right."	"[whirl-d]."
...
Underground River	false	0	0	8	251	--	"One more reverse-paddle, for Roman Hruska. The water picks up speed. You're thrown into the air. But there's a chain there, up and to the right. It flashes and dings, making it 25% more grabbable, or something."	"[whirl-d]."
Underground River	false	1	0	6	495	--	"Got it! Your momentum swings you over to a ledge, where not one but two gates close behind you as you make it to the next area."	"Not all glowing chains are super hot, Dirk. Too bad. Well, if you make it back here, it'll be some good exercise. Not that you need it."
...
U and Pool Balls	false	0	0	16	379	--	"The green ball goes kablooie, and the black ball doesn't even have a crack in it! Well, there's a blue ball passing ahead. It's a dark manly blue, but you won't care about colors if you don't get past it. That leaves just one ball. You have no clue whether it's purple, indigo, or violet, because you hated art. It was enough not to beat up artists."	"You get smooshed by the black ball. Or the green[u-nfair]."
...
Cage and Geyser	false	0	0	32	915	--	"Well, that wasn't too bad. You jump closer to the door."	"Because you didn't charge the door, the electricity--wait for it[if lastmove bit-and 1 is 1] (oops, you already did)[end if]--charges you!"
Cage and Geyser	false	0	0	32	1326	--	"You time the door perfectly! You jump just after it shuts. There's a narrow bridge across, with a huge flume of lava to the left. It sprays every few seconds."	"Hesitating, you time the jump through the door wrong as the electrical current approaches. SNAP!"
Cage and Geyser	false	1	0	8	2191	--	"Your classmates made fun of you because you couldn't count, but man, you sure have timing down. The next flume misses you as you run left."	"Perhaps you felt guilty of your impeccable timing. Or perhaps you just have a fear of crumbly bridges. Or you wonder how the bridge survived the first flume. Whichever, it does not matter now where you are."
Black Knight on Horse	true	--	0	36	1939	--	"You jump out of the way of the lightning, but it still sticks your sword in place."	"You never got to the whys in physics class, but you should've known to get out of the way." [??guessing score as dragons-lair-project doesn't have it]
...
Black Knight on Horse	false	1	0	4	2675	--	"You dive for the hole and make it as the sword lashes against you. Enough of this!"	"Too bad, Dirk! The black knight rides off with your helmet on his sword. How it got there, you may not have figured, and you may not want to know."
...
Smithee	false	0	0	2	915	1326	"Well, the sword being perpendicular to your sword, that gave a greater range--ah, heck, you just swung when it looked like a fat target, and CLANG. Ooh! Here comes a mace!"	"The magic sword descends on you. At least you weren't beaten by someone weaker than you."
Smithee	false	0	0	2	1939	2191	"The mace isn't appreciably different. Well, it's appreciably not different to deflect. But now a glowing anvil up ahead rises and swerves at you. If it had eyes, they'd be glowing even more than the anvil itself, because you kind of killed its two favorite children. Oh, there's also fire to your [r-l]."	"The mace gets too close before you realize you should swing your sword, which shatters."
Smithee	false	0	0	8	1326	1326	"Wow! You duck, but now a spear rises from a weapons rack and spins at you. Time it wrong, and you won't smack it just SO."	"[if went-r]You pause, then jump the wrong way into the fire[else]You couldn't avoid getting clobbered into a wall by the flying anvil[end if]."
...
Snake Room	false	0	0	2	495	--	"And another snake!"	"Bummer, Dirk! Slashing up enemies mindlessly was a strength of yours in simulated heroine rescues, and now wasn't the time to mix things up."
Snake Room	false	0	0	2	2675	--	"The third snake comes down more quickly!"	"The second snake registers no surprise you delayed this time."
Snake Room	false	0	0	3	49	--	"You've got a small breather. That skull on a rope up ahead flashes helpfully. It doesn't look as fun to cut down as those snakes."	"Perhaps you were getting some ennui over the possibility of too many snakes out to get you. Or you just got lazy. Either way, the third snake squeezes you kaput."
...
Goop Room	false	0	0	32	2191	--	"You escape the first wave of goop only to look into a beaker--and out pops a goop monster! Good thing you grabbed it with your off-hand, Dirk."	"Your dawdling is a sticking point--to the green slime below."
Goop Room	false	0	0	2	3255	--	"Splat! Most of the goop behind you disappears as you hack the monster."	"There are bloodier ways to die, but few less gross ways. The goop monster seems to enjoy how you taste, at least."
...
Slide	false	0	0	8	495	--	"You tumble to the right, too busy to consider that it would be someone watching's left. A weird bug-eyed stalk blocks your passage right across the narrow walkway!"	"You fall down the shaft. Really, that was sort of unfair, how quick it happened, but what did you expect, from an evil intelligent dragon?"
Slide	false	0	0	2	1939	--	"And now there's another one, bigger, stronger! If you weren't on a narrow walkway, you'd have no problem, Dirk."	"The stalk grabs you as you try to walk across."
Slide	false	0	0	9	915	--	"You walk up the stairs, and they widen. Ooh! There's a shiny chain to pull ahead! If there was a gap, it could lead you to another room just like that flashing exit to your left would. But if you don't pull it, you'll never know what happens."	"This time you're not quite ready. The stalk is too big. It drags you down!"
...
Fire and Lightning Room	false	0	0	4	915	--	"More lightning strikes from the ceiling! It surrounds you on all sides except to the left. Well, you could probably get away with going up, too."	"[o-w-g]."
Fire and Lightning Room	false	0	0	40	1326	--	"The lightning fire continues to burn to the right and above."	"[p-o-c]!"
...
Fire and Lightning Room	false	1	0	8	1326	--	"Well, what do you know. You're able to move the bench and crawl through the passage."	"[o-w-g]."
Earthquake Room	false	0	0	8	1326	1939	"That's natural. Run where the landslide ain't. What's not natural are the spikes coming out from the wall that blocked you to the [l-r]."	"The path to the [l-r] disappears before you realize it's there, then the ground below you falls, then you."
...
Earthquake Room	false	0	0	32	3551	4026	"Ooh! You ran into a corner. And you can't go back. A spider descends to taunt you."	"You stay by your old friend the wall, the only thing that didn't collapse here. It stays with you as you fall all the way down. There's a lot of it."
...
Earthquake Room	false	0	0	4	5000	5000	"You're by the door out of here, just ahead! To your relief, the ground quits crumbling. But then you realize it's rising--and you'll get crushed by a block coming from above."	"Maybe you feel bad about killing the spider, or whatever. You don't have much time to think about it, though, as you're falling."
Earthquake Room	false	1	0	32	4750	4750	"Whew! That was pretty intimidating, with all the crumbling ground, but you managed to go where the holes ain't. You sort of wish there was someone to congratulate you, so you could be a bit humble!"	"You were pretty boffo at leg presses, Dirk, but you never met weights like this. They converge on you with a SNAP!"
...
Vanishing Checkerboard	false	0	0	32	2675	--	"Oh! Look! Both ways are there! Your momentum is carrying you up, but the door left is flashing. You can't quite remember what was ahead, but it wasn't a door before. And it didn't flash!"	"Your next jump doesn't get you anywhere nearer the exits, or to a more populated area to jump. You fall to your doom."
Vanishing Checkerboard	false	1	0	8	1939	--	"Whew! Good thing the door had a stair ledge."	"[if went-u]Wrong choice, Dirk! Ahead leads to a cage. You scream and rattle the bars, but no luck[else]Faced with two similar-seeming choices, you find a third horrendous one. You fall to your doom[end if]."
...
pd2	false	1	1	8	124	124	"[disc-good-jump]."	"You miss the jump, even though you've prepped for this before. As you tumble, you wonder what your peers would think."
