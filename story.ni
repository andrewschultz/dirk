...
myroom	easy-only	hard-only	finished	wait-check	rightmove	points	reverse	yay	boo	wait-txt
...
Lizard King	false	false	0	0	2	3255	--	"Another stab, another dodge, but the Lizard King looks a bit tireder."	"[sword-should]."
Lizard King	false	false	0	0	2	3255	--	"Another stab, another dodge, but the Lizard King looks even tireder."	"[sword-should]."
Lizard King	false	false	0	0	18	3255	--	"The Lizard King ducks, but he's running on fumes."	"[sword-should]."
Lizard King	false	false	0	0	2	3255	--	"The Lizard King looks totally beat after that last exchange."	"[sword-should]."
...
Giddy Goons	false	false	2	0	34	3255	--	"The goons behind you hyperventilate a bit. They're far enough behind, you [if hard-mode is true]think you can deal with their bigger cousin that just popped out at the top. And you do, without thinking. You're at the top of the spiral staircase. You should probably hit that door to the left before anything pops up from it[else]make it through the door pretty easily[end if]."	"You thought too much, Dirk, and that let the piggies catch up. Aigh!"
...
Electric Throne	false	false	0	0	36	3255	--	"The circle's almost closed. The throne is to the right."	"Zzzzzzap! Megavolts, coming right up."
